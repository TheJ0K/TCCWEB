...
<html>
    ...
    <body class="body-back-color1">
        ...
        <form action="IdeaCompany" method="GET"><!--FORM NEWS IDEA-->
            <div class="col-md-6 well" style="border-color: #0A0A0A;"><!--NEWS AREA COMPANY BLACK--> 
                <%
                    DAL dal = new DAL();
                    LegalPerson legal = (LegalPerson) request.getSession().getAttribute("leg");
                ...
                <div class="well col-md-12" style="background-color: #0A0A0A;"><!--IMAGES AREA-->
                    <center>
                        <a href=""><img src="<% ideascomp.get(i).getImageCompanyIdea(); %>" class="img-rounded" alt="Idea - carousel3" style="width:100%;"></a>
                    </center>
                    <div class="col-md-6">
                        ...
                        <div class="text-body-area" style="color: white;">Company:
                            <span>
                                ${leg.company.nameCompany}
                            </span></div><br>
                ...
                <div class="col-md-12"><!--TITLE AREA-->
                    <center><h1 class="text-title-area" style="color: #0A0A0A;"><% out.print(ideascomp.get(i).getTitleCompanyIdea()); %></h1></center>
                </div>

                <div><!--TEXT DESCRIPTION AREA-->

                    <div class="col-md-12 well sidebar" style="background-color: #0A0A0A; color: white;">DESCRIPTION:
                        <textarea class="form-control" style="height: 200px;" rows="3" disabled="disabled"><% out.print(ideascomp.get(i).getDescriptionCompanyIdea()); %></textarea>
                    </div>
                </div>
