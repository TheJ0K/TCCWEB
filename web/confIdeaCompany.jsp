<%-- 
    Document   : confIdeaCompany
    Created on : 21/06/2017, 00:07:11
                    ...
                    <ul class="nav navbar-nav"><!--MORE FUNCTIONS-->
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                ...
                                <li class="active"><a class="glyphicon glyphicon-star" href="confIdeaCompany.jsp"> MyIdeas</a></li>
                                <li role="separator" class="divider"></li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="col-md-5 well" style="margin-top: 90px; opacity: 0.9"><!--MAIN FORM-->
            ...
            <div id="myTabContent" class="tab-content">
                    ...
                    <form action="IdeaCompCreate" method="GET"><!--FORM FOR SERVELET 'CREATE'-->
                        ...
                        <div><!--NEW IMAGE-->
                            <div class="col-md-12 form-group"><!--C = CREATE or COMPANY-->
                                <label for="inputImageC">Image of Idea</label>
                                <input type="file" class="form-control" placeholder="" name="imageCreateC">
                            </div>
                        </div>

                        <div><!--NEW TITLE-->
                            <div class="col-md-12 form-group"><!--C = CREATE or COMPANY-->
                                <label for="inputTitleC1">Title of Idea</label>
                                <input type="" class="form-control" placeholder="your idea title" name="titleCreateC">
                            </div>
                        </div>

                        <div><!--NEW TEXT DESCRIPTION AREA-->
                            <div class="col-md-12 form-group"><!--C = CREATE or COMPANY-->
                                <label for="inputTitleC2">Description of Idea</label>
                                <textarea class="form-control" name="descriptionCreateC" style="height: 200px;"> </textarea>
                            </div>
                        </div>
                        <br>
                ...
                <div class="tab-pane fade" id="changes">
                    <form action="ideaCompChanges" method="GET">
                        <center>
                            <div class="page-header-1415 text-title" style="margin-top: 5px;">COMPANY | 
                        ...
                        <div><!--TITLE CHANGE-->
                            <div class="col-md-12 form-group"><!--N = NEW | C = COMPANY-->
                                <label for="inputTitleN1">Title to Change</label>
                                <input type="" class="form-control" placeholder="your idea title" name="titleChangesC"><!--OLD TITLE-->
                        ...
                        <div><!--IMAGE-->
                            <div class="col-md-12 form-group">
                                ...
                                <input type="file" class="form-control" placeholder="" name="imageNChangesC"><!--NEW IMAGE-->
                            </div>
                        </div>
                        ...
                        <div><!--TITLE-->
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" class="form-control" placeholder="new title" name="titleNChangesC"><!--NEW TITLE-->
                            </div>
                        </div>
                        ...
                        <div><!--TEXT DESCRIPTION AREA-->
                            <div class="col-md-12 form-group">
                                ...
                                <textarea class="form-control" name="descriptionCreateC" style="height: 200px;"> </textarea><!--NEW DESCRIPTION-->
                            </div>
                        </div>
                        ...
                        <div><!--PASSWORD-->
                            <div class="col-md-6 form-group">
                                ...
                                <input type="password" class="form-control" placeholder="•••••••••" name="passwordChangesC"><!--PASSWORD FOR CONFIRMATION-->
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="inputConfirmPasswordN">Password Confirm</label>
                                <input type="password" class="form-control" placeholder="••••••••••" name="passwordConfirmChangesC"><!--CONFIRM PASSWORD-->
                            </div>
                        </div>
                        <br>
                ...
                <div class="tab-pane fade" id="delete">
                    <form action="ideaCompDelet" method="GET">
                        <center>
                            <div class="page-header-1415 text-title" style="margin-top: 5px;">COMPANY | 
                        ...
                        <div><!--TITLE CHANGE-->
                            <div class="col-md-12 form-group"><!--D = DELETE | C = CONFIRM or C = COMPANY-->
                                <label for="inputTitleD">Title to Delete</label>
                                <input type="text" class="form-control" placeholder="your idea title" name="titleDeleteC">
                            </div>
                            ...
                            <div class="col-md-12 form-group"><!--D = DELETE-->
                                ...
                                <input type="text" class="form-control" placeholder="your idea title" name="titleCDeleteC">
                        ...
                        <div><!--PASSWORD-->
                            <div class="col-md-6 form-group">
                                ...
                                <input type="password" class="form-control" placeholder="•••••••••" name="passwordCreateC">
                            </div>
                            <div class="col-md-6 form-group">
