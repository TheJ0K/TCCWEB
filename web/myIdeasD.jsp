...
<html>
    ...
    <body class="body-back-color1">
                    ...
                    <ul class="nav navbar-nav"><!--MORE FUNCTIONS-->
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                ...
                                <li class=""><a class="glyphicon glyphicon-briefcase" href="ideaCompanyD.jsp"> Companys</a></li>
                                <li role="separator" class="divider"></li>

                                <li><a class="glyphicon glyphicon-list-alt" href="ideaDeveloperD.jsp"> Developers</a></li>
                                <li role="separator" class="divider"></li>

                                <li class="active"><a class="glyphicon glyphicon-star" href="myIdeasD.jsp"> MyIdeas</a></li>
                                <li role="separator" class="divider"></li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div>
            <center>
                <div class="col-md-3">
                    <a style="color: black; border-radius: 15px;" class="col-md-11 navbar-brand btn-info glyphicon glyphicon-wrench shadow" href="confIdeaDeveloper.jsp"> Configure</a>
                </div>
            </center>
        </div>
        <br>
