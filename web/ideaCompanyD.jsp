<%-- 
    Document   : ideaCompanyD
    Created on : 25/06/2017, 11:35:23
...
<html>
    <head>
        ...
        <title>Company Idea - Drop Idea</title>
        <meta charset="UTF-8">
                    ...
                    <ul class="nav navbar-nav"><!--MORE FUNCTIONS-->
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                ...
                                <li class="active"><a class="glyphicon glyphicon-briefcase" href="ideaCompanyD.jsp"> Companys</a></li>
                                <li role="separator" class="divider"></li>
        ...
        <div>
            <center><!--INFORMATIONS-->
                <div class="col-md-12 well"><!--NEW IDEAS AREA-->
                    ...
                    <span class="col-md-4 text-title-text" style="background-color: #0A0A0A;"> COMPANY IDEAS </span>
                </div>
            </center>
        </div>
        ...
        <form action="IdeaCompany" method="SET"><!--FORM NEWS IDEA-->
            <div class="col-md-6 well" style="border-color: #0A0A0A;"><!--NEWS AREA COMPANY BLACK--> 
                ...
                <div class="well col-md-12" style="background-color: #202020;"><!--IMAGES AREA-->
                    ...
                    <div class="text-body-area" style="color: white;">Company: <span> <%out.print(idea.getCompany().getNameCompany());%> </span></div><br><!--COMPANY NAME-->
                    <div class="text-body-area" style="color: white;">Landline Phone: <span> <%out.print(idea.getCompany().getLegalPerson().getPhone().getLandLine());%> </span></div><br>
                ...
                <div class="col-md-12"><!--TITLE AREA-->
                    <center>
                        <h1 class="text-title-area" style="color: #202020;"><% out.print(idea.getTitleCompanyIdea()); %></h1>
                    </center>
                </div>
